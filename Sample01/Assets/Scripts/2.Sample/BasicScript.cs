...
//2. using을 이용해 해당 코드 내에서 사용하는 값은 그 네임스페이스의 값임을 알리고 사용하는 경우(using UnityEngine)
...
//   MonoBehaviour 클래스는 에디터에서 게임 오브젝트에 스크립트를 컴포넌트로써 연결할 수 있는 프레임워크를 제공합니다.
//   Start, Update 와 같은 이벤트에 대한 연결도 제공합니다.
